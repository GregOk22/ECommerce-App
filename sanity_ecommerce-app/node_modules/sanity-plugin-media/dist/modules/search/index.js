...
exports.searchActions = exports.selectIsSearchFacetTag = exports.selectHasSearchFacetTag = exports.searchFacetTagUpdateEpic = void 0;
...
// Selectors
exports.selectHasSearchFacetTag = (0, toolkit_1.createSelector)(function (state) { return state.search.facets; }, function (searchFacets) { return !!(searchFacets === null || searchFacets === void 0 ? void 0 : searchFacets.find(function (facet) { return facet.name === 'tag'; })); });
